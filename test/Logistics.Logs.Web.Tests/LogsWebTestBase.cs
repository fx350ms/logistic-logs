...
public abstract class LogsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static LogsWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(LogsWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<LogsDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<LogsDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<LogsDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<LogsDbContext, Task<T>> func)
    {
        T result;
