...
namespace Logistics.Logs.Migrations
{
    ...
    [Migration("20251203070322_CreatationTimeInt")]
    partial class CreatationTimeInt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Logistics.Logs.Entities.EntityAuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime>("CreatationTime")
                        .HasColumnType("datetime2");

                    b.Property<long>("CreatationTimeInt")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Logistics.Logs.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Logistics.Logs.Authorization.Users.User", null)
                        .WithMany("Claims")
